...
public class AlocacaoManualSalas extends Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        toggleVisao.selectedProperty().addListener((observable, oldValue, newValue) -> {
            ...
            switchScene("AlocacaoManualTurmas", tabela);
        });
    }
                        ...
                        btn2.setOnAction((ActionEvent event) -> {
                            ...
                            try {
                                ...
                                if (selectedTurma != null) {
                                    turmas.add(selectedTurma);
                                }
                                turmas.addAll(getTurmas(alocacao.getHorario()));
                                controller.setSelectTurmas(turmas, selectedTurma);
